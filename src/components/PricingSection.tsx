    ...
    <section id="fiyatlandirma" className="relative py-20 px-6 sm:px-8 bg-gradient-to-b from-transparent via-rose-50/50 to-purple-50/50">
      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch max-w-4xl mx-auto">
          ...
          <Link
            href={standardUrl}
            onClick={() => trackInitiateCheckout('Standart Yıllık Paket', 250)}
            className="group relative flex flex-col justify-between rounded-3xl bg-white/90 backdrop-blur-md p-8 sm:p-10 border border-gray-200/80 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1.5 cursor-pointer block text-inherit no-underline"
          >
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h3 className="text-2xl font-black text-gray-900 group-hover:text-rose-600 transition-colors">Standart Yıllık Paket</h3>
            ...
            <div className="pt-8 space-y-3">
              <div
                className="flex items-center justify-center gap-2 w-full rounded-2xl bg-gray-900 group-hover:bg-rose-600 text-white py-4 px-6 text-sm font-black shadow-lg group-hover:shadow-rose-500/25 transition-all duration-200 group-active:scale-98"
              >
          ...
          <Link
            href={premiumUrl}
            onClick={() => trackInitiateCheckout('Premium VIP Yıllık Paket', 400)}
            className="group relative flex flex-col justify-between rounded-3xl bg-gradient-to-b from-white via-rose-50/70 to-purple-50/70 p-8 sm:p-10 border-2 border-rose-500 shadow-2xl hover:shadow-rose-500/30 transition-all duration-300 hover:-translate-y-1.5 overflow-hidden cursor-pointer block text-inherit no-underline"
          >
            {/* Top Badge */}
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h3 className="text-2xl font-black text-gray-900 group-hover:text-purple-600 transition-colors">Premium VIP Yıllık Paket</h3>
            ...
            <div className="pt-8 space-y-3">
              <div
                className="flex items-center justify-center gap-2 w-full rounded-2xl bg-gradient-to-r from-rose-500 via-pink-600 to-purple-600 group-hover:from-rose-600 group-hover:to-purple-700 text-white py-4 px-6 text-sm font-black shadow-xl shadow-rose-500/25 transition-all duration-200 group-active:scale-98"
              >
